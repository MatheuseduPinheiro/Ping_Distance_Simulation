...
for alcance in alcances:
    ...
    if ping_time is not None:
        ping_times.append(ping_time/100) # A resposta é entregue em número inteiro em ms , necessário alterar a escala(ms) para ter um melhor feedbeck.
    else:
